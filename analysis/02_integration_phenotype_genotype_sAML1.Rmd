...
```{r}
genotype_file = "/hpcnfs/scratch/P_DIMA_SCMSEQ/analysis/scrnaseq/phenotype_genotype/data/enrichment/sAML1.csv"
wes_file = "/hpcnfs/scratch/DIMA/zhan/dragen/231006_aml_caprioli/annotations/variantalker_output/231008/annotation/somatic/S29942_sAML1_D/S29942_sAML1_D.small_mutations.cancervar.escat.maf"
sample_id = "sAML1"
```
...
```{r}
# Read RNAseq
srat = readRDS("/hpcnfs/scratch/P_DIMA_SCMSEQ/analysis/scrnaseq/phenotype_genotype/data/01_tme_annotation.rds")
...
```{r}
DT::datatable(
  data.frame(table(rna$compartment)),
  extensions = 'Buttons',
  options = list(
    dom = 'Blfrtip',
    buttons = c('copy', 'csv', 'excel', 'pdf'),
